...
public class FacilityServiceImpl implements FacilityService {
    ...
    private static final String VILLA_PATH = "src/case_study_module2/data/facility/villa.csv";
    private static final String HOUSE_PATH = "src/case_study_module2/data/facility/house.csv";
    private static final String ROOM_PATH = "src/case_study_module2/data/facility/room.csv";
