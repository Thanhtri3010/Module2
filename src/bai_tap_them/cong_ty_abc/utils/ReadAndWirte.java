...
public class ReadAndWirte {
    ...
    public static List<ManagementStaff> readManagementStaff(String pathFile) {
        ...
        for (String str : list) {
            item = str.split(",");
            managementStaffList.add(new ManagementStaff(item[0],item[1],item[2],item[3],item[4],Integer.parseInt(item[5]),Integer.parseInt(item[6])));
        }
    ...
    public static List<ProductionStaff> readProduction(String pathFile) {
        ...
        for (String str : list) {
            item = str.split(",");
            productionStaffList.add(new ProductionStaff(item[0],item[1],item[2],item[3],item[4],Integer.parseInt(item[5]),Integer.parseInt(item[6])));
        }
