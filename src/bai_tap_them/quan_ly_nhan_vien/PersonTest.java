...
public class PersonTest {
    ...
    static {
        personList[0] = new Student(1, "Thắng", 18, true, 10);
        personList[1] = new Teacher(2, "Linh", 28, false, 1000000);
        personList[2] = new Student(3, "Toàn", 18, true, 9);
        personList[3] = new Teacher(4, "Uyên", 30, false, 2000000);
        personList[4] = new Student(5, "Tâm", 18, true, 8);
        count = 5;
    }
